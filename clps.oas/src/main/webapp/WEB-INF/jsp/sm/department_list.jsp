				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row">
							...
							<!-- <form class="bs-example bs-example-form col-md-5" role="form"
								style="margin: 20px 0 10px 0;" action="/admin/selectCourse"
							...
							<button class="btn btn-default col-md-2"
								...
								onClick="location.href='toAddDepartment'">
								新增部门信息
					...
					<div style="float: left; width: 50%; height: 100px;">
						<button class="btn btn-default col-md-2" style="margin-top: 20px"
							onClick="location.href='<%=request.getContextPath()%>/sm/exportDepartmentVoToExcel'">execl导出</button>
					</div>
					<div style="float: left; width: 50%; height: 100px;">
						<button class="btn btn-default col-md-2" style="margin-top: 20px"
							onClick="location.href='<%=request.getContextPath()%>/sm/importDepartmentVoFromExcel'">execl导入</button>
					</div>
				</div> --%>
