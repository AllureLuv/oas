			...
			<div class="col-md-10">
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row">
							<h1 style="text-align: center;">修改职员信息</h1>
						</div>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" role="form"
							action="<%=basePath%>/sm/editEmployee" id="updateEmployee"
							method="post">
							<div class="form-group">
							    <label for="inputEmail3" class="col-sm-2 control-label">职员编号<span
									style="color: red">&nbsp;&nbsp;*</span></label>
							    <div class="col-sm-10">
							      <input readonly="readonly"  type="number" class="form-control" id="inputEmail3" value="${requestScope.employee.employeeId}" name="employeeId" placeholder="此项不可修改">
							    </div>
							  </div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="inputEmail3"
										name="employeeName" required="required" value="${requestScope.employee.employeeName}" placeholder="请输入职员姓名">
								</div>
							</div>
							<div class="form-group">
