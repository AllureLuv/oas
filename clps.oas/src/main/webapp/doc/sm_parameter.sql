...
create table PARAMETER(
	...
	parameter__updated_datetime timestamp NOT NULL DEFAULT   ON UPDATE CURRENT_TIMESTAMP COMMENT '参数修改时间',
...
) VALUES("pageSize","10",0,"Page maximum capacity",'2018-11-15 10:30:03',1,'2018-11-15 10:30:03',1,1,"111","111");

INSERT INTO PARAMETER(parameter_name,parameter_conent,parameter_spuelId,parameter__comment,
parameter_created_datetime,parameter_created_name,parameter__updated_datetime,parameter_updated_name,
parameter_isvariable,user_default1,user_default2
) VALUES("fileSaveRootPath","/doc/excelTemplate",0,"Upload path",'2018-11-15 10:30:03',1,'2018-11-15 10:30:03',1,1,"111","111");