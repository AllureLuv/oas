...
public class Document implements Serializable {
    ...
    *//**  
    ...
    private Integer documentCreatedName;// 文件创建人

    private Date documentUpdatedDatetime; // 文件修改时间

    private Integer documentUpdatedName;// 文件修改人
	...
	*//**
	 ...
	 *//*
	public Integer getDocumentCreatedName() {
	...
	*//**
	 ...
	 *//*
	public void setDocumentCreatedName(Integer documentCreatedName) {
	...
	*//**
	 ...
	 *//*
	public Integer getDocumentUpdatedName() {
	...
	*//**
	 ...
	 *//*
	public void setDocumentUpdatedName(Integer documentUpdatedName) {
	...
	*//**  
	...
	public Document(String documentTitle, String documentName, String documentComment, Date documentCreatedDatetime,
			Integer documentCreatedName, Date documentUpdatedDatetime, Integer documentUpdatedName,
			Boolean documentIsvalid) {
		super();
		this.documentTitle = documentTitle;
		this.documentName = documentName;
		this.documentComment = documentComment;
	...
	*//**  
	 ...
	 * @throws  
	 *//*
	public Document(Integer documentId, String documentTitle, String documentName, String documentComment,
			Date documentCreatedDatetime, Integer documentCreatedName, Date documentUpdatedDatetime,
			Integer documentUpdatedName, Boolean documentIsvalid) {
		super();
		this.documentId = documentId;
		this.documentTitle = documentTitle;
		this.documentName = documentName;
	...
	public String toString() {
		return "Document [documentId=" + documentId + ", documentTitle=" + documentTitle + ", documentName="
				+ documentName + ", documentComment=" + documentComment + ", documentCreatedDatetime="
				+ documentCreatedDatetime + ", documentCreatedName=" + documentCreatedName
				+ ", documentUpdatedDatetime=" + documentUpdatedDatetime + ", documentUpdatedName="
				+ documentUpdatedName + ", documentIsvalid=" + documentIsvalid + "]";
	}
}*/
