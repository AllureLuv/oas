...
public class PermissionServiceImpl implements IPermissionService {
	...
	@Override
	public List<PermissionVO> findByPaging(Integer toPage) throws Exception {
		PagingVO pagingVO = new PagingVO();
        pagingVO.setToPage(toPage);
        List<PermissionVO> list = permissionDao.findByPaging(pagingVO);
        return list;
		/**
		* @descirption
		* @param
	...
	public int countByExample() {
		return this.permissionDao.countByExample();
		/**
		* @descirption
		* @param
		* @return
