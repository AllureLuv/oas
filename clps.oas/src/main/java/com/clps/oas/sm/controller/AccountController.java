...
public class AccountController implements Serializable {
	...
	@RequestMapping("/account_addView2")
	public String addView2(Model model) {
		return "sm/account_add2";
	}

	@RequestMapping(value = "/addAccount")
	public String addAccount(HttpServletRequest request, HttpSession session, Account account) throws IOException {
		...
		account.setAccountTelephone(request.getParameter("accountTelephone"));
	...
	@RequestMapping(value = "/addAccount2")
	public String addAccount2(HttpServletRequest request, HttpSession session, Account account) throws IOException {
