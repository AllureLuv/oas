...
public class ParameterServiceImpl implements IParameterService{
	...
	@Override
	public List<Parameter> findByName(String name) throws Exception {    
		return patDao.findByName(name);
				
		
	}

	@Override
	public List<Parameter> queryAllParametersByPaging(Integer toPage) {
		PagingVO pagingVO = new PagingVO();
		pagingVO.setToPage(toPage);
		return this.patDao.queryAllParametersByPaging(pagingVO);
	}
	

	@Override
	public int countParameters() {
		return this.patDao.countParameters();
	}
