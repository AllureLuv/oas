...
public class DepartmentMapperTest {
	...
	/**
	 * Test method for
	 * {@link com.clps.oas.sm.dao.DepartmentMapper#deleteByPrimaryKey(java.lang.Integer)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.clps.oas.sm.dao.DepartmentMapper#insert(com.clps.oas.sm.pojo.Department)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.clps.oas.sm.dao.DepartmentMapper#insertSelective(com.clps.oas.sm.pojo.Department)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.clps.oas.sm.dao.DepartmentMapper#selectByPrimaryKey(java.lang.Integer)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.clps.oas.sm.dao.DepartmentMapper#updateByPrimaryKeySelective(com.clps.oas.sm.pojo.Department)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.clps.oas.sm.dao.DepartmentMapper#updateByPrimaryKey(com.clps.oas.sm.pojo.Department)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.clps.oas.sm.dao.DepartmentMapper#queryAllDepartments()}.
	 */
	@Test
	...
	public void testqueryDepartmentsById() {
		...
		try {
			...
			Department department = mapper.queryDepartmentsById(3);
			log.info(department);
			session.commit();
		} catch (Exception e) {
			session.rollback();
	...
	public void testcountByExample() {
		try {
			...
			log.info(mapper.countDepartments());
			session.commit();
		} catch (Exception e) {
			session.rollback();
		} finally {
	...
	public void testqueryDepartmentByPaging(){
		try{
		    ...
		    this.lists=mapper.queryDepartmentByPaging(pagingVo);
		    Iterator<Department> its=lists.iterator();
		    while (its.hasNext()) {
	...
	public void testQueryDepartmentsByName() {
		try {
			this.lists = mapper.queryDepartmentsByName("人事");
			Iterator<Department> its = lists.iterator();
			while (its.hasNext()) {
				System.out.println(its.next());
			}
